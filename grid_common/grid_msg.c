...
void grid_msg_store_lastheader(struct grid_msg_model *mod,
                               enum grid_msg_lastheader_index_t index,
                               uint8_t value) {
...
uint8_t grid_msg_get_lastheader_state(struct grid_msg_model *mod,
                                      enum grid_msg_lastheader_index_t index) {
  return mod->lastheader[index].state;
}

uint8_t grid_msg_get_lastheader_id(struct grid_msg_model *mod,
                                   enum grid_msg_lastheader_index_t index) {
  return mod->lastheader[index].id;
}

void grid_msg_clear_lastheader(struct grid_msg_model *mod,
                               enum grid_msg_lastheader_index_t index) {

  mod->lastheader[index].state = 0; // 0 means operation completed
}

void grid_msg_set_editor_heartbeat_lastrealtime(struct grid_msg_model *mod,
                                                uint64_t timestamp) {
  mod->editor_heartbeat_lastrealtime = timestamp;
}

uint32_t
grid_msg_get_editor_heartbeat_lastrealtime(struct grid_msg_model *mod) {
...
void grid_msg_header_set_len(struct grid_msg_packet *msg, uint16_t len) {
  ...
  uint8_t error = 0;
  grid_msg_string_set_parameter(msg->header, GRID_BRC_LEN_offset,
                                GRID_BRC_LEN_length, len, &error);
}

uint16_t grid_msg_header_get_len(struct grid_msg_packet *msg) {

  uint8_t error = 0;
  return grid_msg_string_get_parameter(msg->header, GRID_BRC_LEN_offset,
                                       GRID_BRC_LEN_length, &error);
}
...
void grid_msg_header_set_id(struct grid_msg_packet *msg, uint8_t id) {
  ...
  uint8_t error = 0;
  grid_msg_string_set_parameter(msg->header, GRID_BRC_ID_offset,
                                GRID_BRC_ID_length, id, &error);
}

uint8_t grid_msg_header_get_id(struct grid_msg_packet *msg) {

  uint8_t error = 0;
  return grid_msg_string_get_parameter(msg->header, GRID_BRC_ID_offset,
...
void grid_msg_header_set_dx(struct grid_msg_packet *msg, uint8_t dx) {
  ...
  uint8_t error = 0;
  grid_msg_string_set_parameter(msg->header, GRID_BRC_DX_offset,
                                GRID_BRC_DX_length, dx, &error);
}

uint8_t grid_msg_header_get_dx(struct grid_msg_packet *msg) {

  uint8_t error = 0;
  return grid_msg_string_get_parameter(msg->header, GRID_BRC_DX_offset,
...
void grid_msg_header_set_dy(struct grid_msg_packet *msg, uint8_t dy) {
  ...
  uint8_t error = 0;
  grid_msg_string_set_parameter(msg->header, GRID_BRC_DY_offset,
                                GRID_BRC_DY_length, dy, &error);
}

uint8_t grid_msg_header_get_dy(struct grid_msg_packet *msg) {

  uint8_t error = 0;
  return grid_msg_string_get_parameter(msg->header, GRID_BRC_DY_offset,
...
void grid_msg_header_set_sx(struct grid_msg_packet *msg, uint8_t sx) {
  ...
  uint8_t error = 0;
  grid_msg_string_set_parameter(msg->header, GRID_BRC_SX_offset,
                                GRID_BRC_SX_length, sx, &error);
}

uint8_t grid_msg_header_get_sx(struct grid_msg_packet *msg) {

  uint8_t error = 0;
  return grid_msg_string_get_parameter(msg->header, GRID_BRC_SX_offset,
...
void grid_msg_header_set_sy(struct grid_msg_packet *msg, uint8_t sy) {
  ...
  uint8_t error = 0;
  grid_msg_string_set_parameter(msg->header, GRID_BRC_SY_offset,
                                GRID_BRC_SY_length, sy, &error);
}

uint8_t grid_msg_header_get_sy(struct grid_msg_packet *msg) {

  uint8_t error = 0;
  return grid_msg_string_get_parameter(msg->header, GRID_BRC_SY_offset,
...
void grid_msg_header_set_rot(struct grid_msg_packet *msg, uint8_t rot) {
  ...
  uint8_t error = 0;
  grid_msg_string_set_parameter(msg->header, GRID_BRC_ROT_offset,
                                GRID_BRC_ROT_length, rot, &error);
}

uint8_t grid_msg_header_get_rot(struct grid_msg_packet *msg) {

  uint8_t error = 0;
  return grid_msg_string_get_parameter(msg->header, GRID_BRC_ROT_offset,
...
void grid_msg_header_set_age(struct grid_msg_packet *msg, uint8_t age) {
  ...
  uint8_t error = 0;
  grid_msg_string_set_parameter(msg->header, GRID_BRC_MSGAGE_offset,
                                GRID_BRC_MSGAGE_length, age, &error);
}

uint8_t grid_msg_header_get_age(struct grid_msg_packet *msg) {

  uint8_t error = 0;
  return grid_msg_string_get_parameter(msg->header, GRID_BRC_MSGAGE_offset,
                                       GRID_BRC_MSGAGE_length, &error);
}
...
void grid_msg_header_set_session(struct grid_msg_packet *msg, uint8_t session) {
  ...
  uint8_t error = 0;
  grid_msg_string_set_parameter(msg->header, GRID_BRC_SESSION_offset,
                                GRID_BRC_SESSION_length, session, &error);
}

uint8_t grid_msg_header_get_session(struct grid_msg_packet *msg) {

  uint8_t error = 0;
  return grid_msg_string_get_parameter(msg->header, GRID_BRC_SESSION_offset,
                                       GRID_BRC_SESSION_length, &error);
}
...
void grid_msg_packet_body_append_printf(struct grid_msg_packet *msg,
                                        char const *fmt, ...) {
...
void grid_msg_packet_body_append_parameter(struct grid_msg_packet *msg,
  ...
  grid_msg_packet_body_set_parameter(msg, text_start_offset, parameter_offset,
                                     parameter_length, value);
}

uint32_t grid_msg_packet_body_get_parameter(struct grid_msg_packet *msg,
  ...
  return grid_msg_string_read_hex_string_value(
      &msg->body[text_start_offset + parameter_offset], parameter_length,
      &error);
}

void grid_msg_packet_body_set_parameter(struct grid_msg_packet *msg,
                                        uint32_t text_start_offset,
                                        uint8_t parameter_offset,
                                        uint8_t parameter_length,
                                        uint32_t value) {

  return grid_msg_string_write_hex_string_value(
      &msg->body[text_start_offset + parameter_offset], parameter_length,
      value);
}
...
void grid_msg_packet_init(struct grid_msg_model *mod,
                          struct grid_msg_packet *msg, uint8_t dx, uint8_t dy) {
  ...
  sprintf((char *)msg->header, GRID_BRC_frame_quick, GRID_CONST_SOH,
          GRID_CONST_BRC, session, dx, dy, GRID_CONST_EOB);
...
// ======================= MSG RECEIVE CHAR ======================//
void grid_msg_packet_receive_char_by_char(struct grid_msg_packet *msg,
                                          uint8_t nextchar) {
...
uint8_t grid_msg_packet_send_char_by_char(struct grid_msg_packet *msg,
                                          uint32_t charindex) {
  ...
  if (charindex < msg->header_length) {
    ...
    return msg->body[charindex - msg->header_length];
             ...
             msg->footer_length + msg->body_length + msg->header_length) {
...
void grid_msg_packet_close(struct grid_msg_model *mod,
                           struct grid_msg_packet *msg) {

  sprintf((char *)&msg->footer[msg->footer_length], "%c", GRID_CONST_EOT);
  msg->footer_length += strlen((char *)&msg->footer[msg->footer_length]);

  grid_msg_header_set_len(msg, msg->header_length + msg->body_length +
                                   msg->footer_length);
...
uint8_t grid_msg_recent_fingerprint_find(struct grid_msg_model *model,
                                         uint32_t fingerprint) {

  for (GRID_MSG_RECENT_FINGERPRINT_BUFFER_INDEX_T i = 0;
       i < GRID_MSG_RECENT_FINGERPRINT_BUFFER_LENGTH; i++) {

    if (model->recent_messages[i % GRID_MSG_RECENT_FINGERPRINT_BUFFER_LENGTH] ==
        fingerprint) {
...
void grid_msg_recent_fingerprint_store(struct grid_msg_model *model,
                                       uint32_t fingerprint) {
...
uint8_t grid_msg_string_calculate_checksum_of_string(char *str,
                                                     uint32_t length) {
...
void grid_msg_string_checksum_write(char *message, uint32_t length,
                                    uint8_t checksum) {
...
uint32_t grid_msg_string_get_parameter(char *message, uint16_t offset,
                                       uint8_t length, uint8_t *error) {

  return grid_msg_string_read_hex_string_value(&message[offset], length, error);
}

void grid_msg_string_set_parameter(char *message, uint16_t offset,
...
void grid_msg_string_write_hex_string_value(char *start_location, uint8_t size,
                                            uint32_t value) {
