...
void grid_esp32_swd_pico_program_sram(uint8_t swclk_pin, uint8_t swdio_pin, uint8_t* buffer, uint32_t length) {
  ...
  if (1) {
    ...
    swd_read_idcode();
    swd_dummy_clock();
    swd_write_abort(0x00000010);
    swd_dummy_clock();
    swd_read_ctrlstat();
    swd_dummy_clock(); // 0x00000001
    swd_read_ap0();
    swd_dummy_clock(); // 0x0
    swd_read_buff();
    swd_dummy_clock(); // 0x40001
    ...
    swd_read_ctrlstat();
    swd_dummy_clock(); // 0x00000001
    swd_write_select(0x000000f3);
    swd_dummy_clock();
    swd_read_apc();
    swd_idle();
    swd_read_buff();
    swd_dummy_clock(); // 0x04770031
    swd_write_select(0x00000003);
    swd_dummy_clock();
    swd_write_ap0(0xa2000020);
    swd_dummy_clock();
    swd_write_ap4(0x00000000);
    swd_dummy_clock();
    swd_read_ap0();
    swd_dummy_clock(); // 0x0
    swd_read_buff();
    swd_dummy_clock(); // 0x03000040
    swd_write_select(0x000000f3);
    swd_dummy_clock();
    swd_read_ap4();
    swd_dummy_clock(); // 0x00
    swd_read_buff();
    swd_dummy_clock(); // 0x00
    ...
    swd_write_select(0x00000003);
    swd_dummy_clock();
    swd_write_ap0(0xa2000022);
    swd_dummy_clock();
    swd_write_ap4(0xe000edf0);
    swd_dummy_clock();
    swd_write_select(0x00000013);
    swd_dummy_clock();
    swd_read_ap0();
    swd_dummy_clock(); // 0x00
    swd_read_buff();
    swd_dummy_clock(); // 0x40001
    swd_write_ap0(0xa05f0003);
    swd_dummy_clock();
    swd_write_ap8(0x00000000);
    swd_dummy_clock();
    swd_write_ap0(0xa05f0003);
    swd_dummy_clock();
    swd_write_select(0x00000003);
    swd_dummy_clock();
    swd_write_ap4(0xe000ed30);
    swd_dummy_clock();
    swd_write_select(0x00000013);
    swd_dummy_clock();
    swd_read_ap0();
    swd_dummy_clock(); // 0x00
    swd_read_buff();
    swd_dummy_clock(); // 0x01
    swd_write_ap0(0x00000001);
    swd_dummy_clock();
    swd_write_select(0x00000003);
    swd_dummy_clock();
    swd_write_ap4(0xe000edf0);
    ...
    swd_write_select(0x00000013);
    swd_dummy_clock();
    swd_write_ap0(0xa05f0001);
    swd_dummy_clock();
    swd_write_select(0x00000003);
    swd_dummy_clock();
    swd_write_ap4(0xe000ed00);
    swd_dummy_clock();
    swd_write_select(0x00000013);
    swd_dummy_clock();
    swd_write_apc(0x05fa0004);
    swd_dummy_clock();
    swd_write_select(0x00000010);
    swd_dummy_clock();
    swd_read_ctrlstat();
    swd_dummy_clock(); // 0xf0000041
    swd_write_select(0x00000000);
    swd_dummy_clock();
    swd_write_ctrlstat(0x50000020);
    swd_dummy_clock();
    swd_read_ctrlstat();
    swd_dummy_clock(); // 0xf0000040
    swd_write_ctrlstat(0x50000000);
    swd_dummy_clock();
    swd_read_ctrlstat();
    swd_dummy_clock(); // 0xf0000040
    ...
    swd_dummy_clock(); // 0x00
    swd_read_buff();
    swd_dummy_clock(); // 0x00040001
    swd_read_apc();
    swd_idle();
    swd_read_buff();
    swd_dummy_clock(); // 0x0x01000000
    swd_write_ap8(0x00000000);
    swd_dummy_clock();
    swd_read_ap0();
    swd_dummy_clock(); // 0xe00ff003
    swd_read_buff();
    swd_dummy_clock(); // 0x00040001
    swd_write_apc(0x01000000);
    swd_dummy_clock();
    swd_write_select(0x00000003);
    swd_dummy_clock();
    swd_write_ap0(0xa2000012);
    swd_dummy_clock();
    swd_write_ap4(0xe0002000);
    swd_dummy_clock();
    swd_write_apc(0x00000003);
    swd_dummy_clock();
    swd_write_ap4(0xe0002000);
    swd_dummy_clock();
    swd_read_apc();
    swd_idle();
    swd_read_buff();
    swd_dummy_clock(); // 0x00000041
    swd_write_ap4(0xe0002008);
    swd_dummy_clock();
    swd_write_apc(0x00000000);
    swd_dummy_clock();
    swd_write_apc(0x00000000);
    swd_dummy_clock();
    swd_write_apc(0x00000000);
  ...
  if (1) {
    ...
    swd_dummy_clock(); // 0x00
    swd_read_buff();
    swd_dummy_clock(); // 0x00030003
    swd_write_ap4(0x00000000);
    swd_dummy_clock();
    swd_read_ap8();
    swd_dummy_clock(); // 0x00
    swd_read_buff();
    swd_dummy_clock(); // 0x501008b0
    swd_write_ap4(0x00000001);
    swd_dummy_clock();
    swd_read_ap8();
    swd_dummy_clock(); // 0x00
    swd_read_buff();
    swd_dummy_clock(); // 0x00
    swd_write_ap4(0x00000002);
    swd_dummy_clock();
    swd_read_ap8();
    swd_dummy_clock(); // 0x00
    swd_read_buff();
    swd_dummy_clock(); // 0x3ecc
    swd_write_ap4(0x00000003);
    swd_dummy_clock();
    swd_read_ap8();
    swd_dummy_clock(); // 0x00
    swd_read_buff();
    swd_dummy_clock(); // 0x00
    swd_write_ap4(0x00000004);
    swd_dummy_clock();
    swd_read_ap8();
    swd_dummy_clock(); // 0x00
    swd_read_buff();
    swd_dummy_clock(); // 0x50100e84
    swd_write_ap4(0x00000005);
    swd_dummy_clock();
    swd_read_ap8();
    swd_dummy_clock(); // 0x00
    swd_read_buff();
    swd_dummy_clock(); // 0x00
    swd_write_ap4(0x00000006);
    swd_dummy_clock();
    swd_read_ap8();
    swd_dummy_clock(); // 0x00
    swd_read_buff();
    swd_dummy_clock(); // 0x00
    swd_write_ap4(0x00000007);
    swd_dummy_clock();
    swd_read_ap8();
    swd_dummy_clock(); // 0x00
    swd_read_buff();
    swd_dummy_clock(); // 0x50100eac
    swd_write_ap4(0x00000008);
    swd_dummy_clock();
    swd_read_ap8();
    swd_dummy_clock(); // 0x00
    swd_read_buff();
    swd_dummy_clock(); // 0xffffffff
    swd_write_ap4(0x00000009);
    swd_dummy_clock();
    swd_read_ap8();
    swd_dummy_clock(); // 0x00
    swd_read_buff();
    swd_dummy_clock(); // 0xffffffff
    swd_write_ap4(0x0000000a);
    swd_dummy_clock();
    swd_read_ap8();
    swd_dummy_clock(); // 0x00
    swd_read_buff();
    swd_dummy_clock(); // 0xffffffff
    swd_write_ap4(0x0000000b);
    swd_dummy_clock();
    swd_read_ap8();
    swd_dummy_clock(); // 0x00
    swd_read_buff();
    swd_dummy_clock(); // 0xffffffff
    swd_write_ap4(0x0000000c);
    swd_dummy_clock();
    swd_read_ap8();
    swd_dummy_clock(); // 0x00
    swd_read_buff();
    swd_dummy_clock(); // 0x50100000
    swd_write_ap4(0x0000000d);
    swd_dummy_clock();
    swd_read_ap8();
    swd_dummy_clock(); // 0x00
    swd_read_buff();
    swd_dummy_clock(); // 0x50100898
    swd_write_ap4(0x0000000e);
    swd_dummy_clock();
    swd_read_ap8();
    swd_dummy_clock(); // 0x00
    swd_read_buff();
    swd_dummy_clock(); // 0x000002b3
    swd_write_ap4(0x0000000f);
    swd_dummy_clock();
    swd_read_ap8();
    swd_dummy_clock(); // 0x00
    swd_read_buff();
    swd_dummy_clock(); // 0x000020f0
    swd_write_ap4(0x00000010);
    swd_dummy_clock();
    swd_read_ap8();
    swd_dummy_clock(); // 0x00
    swd_read_buff();
    swd_dummy_clock(); // 0x61000000
    swd_write_ap4(0x00000011);
    swd_dummy_clock();
    swd_read_ap8();
    swd_dummy_clock(); // 0x00
    swd_read_buff();
    swd_dummy_clock(); // 0x50100898
    swd_write_ap4(0x00000012);
    swd_dummy_clock();
    swd_read_ap8();
    swd_dummy_clock(); // 0x00
    swd_read_buff();
    swd_dummy_clock(); // 0xfffffffc
    swd_write_ap4(0x00000014);
    swd_dummy_clock();
    swd_read_ap8();
    swd_dummy_clock(); // 0x00
    swd_read_buff();
    swd_dummy_clock(); // 0x00000000
...
#define BIN_SIZE 18060
  ...
  if (1) {
    ...
    swd_read_ctrlstat();
    swd_dummy_clock(); // 0x00000001
    swd_write_ap8(0x20000000);
    swd_dummy_clock();
    swd_write_ap4(0x0001000f);
    swd_dummy_clock();
