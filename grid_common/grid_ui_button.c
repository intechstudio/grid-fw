...
const char grid_ui_button_init_actionstring[] = GRID_ACTIONSTRING_INIT_BUT;
const char grid_ui_button_change_actionstring[] = GRID_ACTIONSTRING_BC;
const char grid_ui_button_timer_actionstring[] = GRID_ACTIONSTRING_TIMER;

void grid_ui_element_button_init(struct grid_ui_element* ele){
  
  ele->type = GRID_UI_ELEMENT_BUTTON;

  ele->event_list_length = 3;

  ele->event_list = malloc(ele->event_list_length * sizeof(struct grid_ui_event));

  grid_ui_event_init(ele, 0, GRID_UI_EVENT_INIT, GRID_LUA_FNC_ACTION_INIT_short, grid_ui_button_init_actionstring);       // Element Initialization Event
  grid_ui_event_init(ele, 1, GRID_UI_EVENT_BC, GRID_LUA_FNC_ACTION_BUTTONCHANGE_short, grid_ui_button_change_actionstring); // Button Change
  grid_ui_event_init(ele, 2, GRID_UI_EVENT_TIMER, GRID_LUA_FNC_ACTION_TIMER_short, grid_ui_button_timer_actionstring);
