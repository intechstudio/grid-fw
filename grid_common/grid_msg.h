...
struct grid_msg_packet{
	...
	uint8_t header[grid_msg_packet_header_maxlength];
	uint8_t body[grid_msg_packet_body_maxlength];
...
void	grid_msg_packet_body_append_text(struct grid_msg_packet* msg, uint8_t* string);
