...
#define CONF_USB_COMPOSITE_IMANUFACT_STR "Intech Studio"
#endif

#ifndef CONF_USB_COMPOSITE_IMANUFACT_STR_DESC
#define CONF_USB_COMPOSITE_IMANUFACT_STR_DESC                                                                          \
	28, 0x03, 'I', 0x00, 'n', 0x00, 't', 0x00, 'e', 0x00, 'c', 0x00, 'h', 0x00, ' ', 0x00, 'S', 0x00, 't', 0x00, 'u',  \
	    0x00, 'd', 0x00, 'i', 0x00, 'o', 0x00,
#endif
...
#define CONF_USB_COMPOSITE_IPRODUCT_STR "Intech Studio: Grid"
#endif
...
#define CONF_USB_COMPOSITE_IPRODUCT_STR_DESC                                                                           \
	40, 0x03, 'I', 0x00, 'n', 0x00, 't', 0x00, 'e', 0x00, 'c', 0x00, 'h', 0x00, ' ', 0x00, 'S', 0x00, 't', 0x00, 'u',  \
	    0x00, 'd', 0x00, 'i', 0x00, 'o', 0x00, ':', 0x00, ' ', 0x00, 'G', 0x00, 'r', 0x00, 'i', 0x00, 'd', 0x00,
#endif
...
#define CONF_USB_COMPOSITE_BMAXPOWER 0xfa
#endif
// </h>
