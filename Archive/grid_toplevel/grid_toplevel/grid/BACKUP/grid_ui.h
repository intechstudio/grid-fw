...
// 120, 121 & 220 kills it
#define GRID_UI_ACTION_STRING_maxlength			121
#define GRID_UI_EVENT_STRING_maxlength			16

#define GRID_UI_ACTION_PARAMETER_maxcount		14
//#define GRID_UI_ACTION_PARAMETER_maxcodelength	4
...
//	uint8_t code[GRID_UI_ACTION_PARAMETER_maxcodelength];
...
struct grid_ui_element
{
	...
	uint32_t* template_a_parameter_list;
