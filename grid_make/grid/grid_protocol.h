...
#define GRID_ACTIONSTRING_INIT_POT "<?lua --[[@cb]]local num,val,red,gre,blu = this.ind(),this.pva(),glr(),glg(),glb() --[[@glc]]glc(num,1,red,gre,blu) --[[@glp]]glp(num,1,val) ?>"

#define GRID_ACTIONSTRING_INIT_BUT "<?lua --[[@cb]]local num,val,red,gre,blu = this.ind(),this.bva(),glr(),glg(),glb() --[[@glc]]glc(num,1,red,gre,blu) --[[@glp]]glp(num,1,val) ?>"
#define GRID_ACTIONSTRING_INIT_ENC "<?lua --[[@cb]]local num,bval,eval,red,gre,blu = this.ind(),this.bva(),this.eva(),glr(),glg(),glb() --[[@glc]]glc(num,1,red,gre,blu) --[[@glc]]glc(num,2,red,gre,blu) --[[@glp]]glp(num,1,bval) --[[@glp]]glp(num,2,eval) ?>"
