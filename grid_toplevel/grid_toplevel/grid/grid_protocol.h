...
#define GRID_DEFAULT_ACTION_INIT_ENC	"\x02""041fA001B1B2B3\x03\x02""041fA002B1B2B3\x03""\x02""040fA001A3\x03"
...
#define GRID_CLASS_DEBUGTEXT_frame_start			"%c%03xf",GRID_CONST_STX,GRID_CLASS_DEBUGTEXT_code
