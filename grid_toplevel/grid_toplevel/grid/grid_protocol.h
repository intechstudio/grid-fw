...
#define GRID_INSTR_FETCH_code				0xF//0x65 //e

// Execute The Action if possible!
#define GRID_INSTR_EXECUTE_code				0xE//0x66 //f
...
#define GRID_EVENT_HEARTBEAT	"\x02""050eB000000100\x03"

#define GRID_EVENT_AVC7_POT		"\x02""050eB001A002A2\x03"

#define GRID_EVENT_DP_BUT		"\x02""050eB002A005A6\x03"
#define GRID_EVENT_DR_BUT		"\x02""050eB002A006A6\x03"

#define GRID_EVENT_AVC7_ENC		"\x02""050eB003A002A2\x03"
#define GRID_EVENT_DP_ENC		"\x02""050eB003A005A6\x03"
#define GRID_EVENT_DR_ENC		"\x02""050eB003A006A6\x03"





#define GRID_EVENT_MAPMODE_PRESS	"\x02""050eB0000008B4\x03"
#define GRID_EVENT_MAPMODE_RELEASE	"\x02""050eB0000009B4\x03"

#define GRID_EVENT_CFG_RESPONES		"\x02""050eB000000aB4\x03"
#define GRID_EVENT_CFG_REQUEST		"\x02""050eB000000bB4\x03"


// DEFAULT ACTION:                     FIRST MIDI then LED_SET_PHASE

#define GRID_DEFAULT_ACTION_INIT		"\x02""041eA001B1B2B3\x03\x02""041eA002B1B2B3\x03"
#define GRID_DEFAULT_ACTION_INIT_ENC	"\x02""041eA001B1B2B3\x03\x02""041eA002B1B2B3\x03""\x02""040eA001A3\x03"

#define GRID_DEFAULT_ACTION_AVC7   "\x02""000e00b0A0A2\x03\x02""040eA001A3\x03"
#define GRID_DEFAULT_ACTION_DP     "\x02""000e0090A0A6\x03\x02""040eA001A7\x03"
#define GRID_DEFAULT_ACTION_DR     "\x02""000e0080A0A6\x03\x02""040eA001A7\x03"

#define GRID_DEFAULT_ACTION_DP_ENC     "\x02""000e0090A0A6\x03\x02""040eA002A7\x03"
#define GRID_DEFAULT_ACTION_DR_ENC     "\x02""000e0080A0A6\x03\x02""040eA002A7\x03"

#define GRID_DEFAULT_ACTION_DR_ENC     "\x02""000e0080A0A6\x03\x02""040eA002A7\x03"
#define GRID_DEFAULT_ACTION_DR_ENC     "\x02""000e0080A0A6\x03\x02""040eA002A7\x03"

#define GRID_DEFAULT_ACTION_MAPMODE_PRESS		"\x02""030eB5\x03"
#define GRID_DEFAULT_ACTION_MAPMODE_RELEASE		""

#define GRID_DEFAULT_ACTION_CFG_RESPONSE		"\x02""030eB0\x03"
#define GRID_DEFAULT_ACTION_CFG_REQUEST 		"\x02""030fB0\x03"
...
#define GRID_CLASS_EVENT_ELEMENTTYPE_offset				7
#define GRID_CLASS_EVENT_ELEMENTTYPE_length				2

#define GRID_CLASS_EVENT_ELEMENTNUMBER_offset			9
#define GRID_CLASS_EVENT_ELEMENTNUMBER_length			2

#define GRID_CLASS_EVENT_EVENTTYPE_offset				11
...
#define GRID_CLASS_STOREGLOBAL_frame				"%c%03xe%c",GRID_CONST_STX,GRID_CLASS_STOREGLOBAL_code,GRID_CONST_ETX

#define GRID_CLASS_STORELOCAL_code					0x061
#define GRID_CLASS_STORELOCAL_frame					"%c%03xe%c",GRID_CONST_STX,GRID_CLASS_STORELOCAL_code,GRID_CONST_ETX




#define GRID_CLASS_LOADGLOBAL_code					0x070
#define GRID_CLASS_LOADGLOBAL_frame					"%c%03xe%c",GRID_CONST_STX,GRID_CLASS_LOADGLOBAL_code,GRID_CONST_ETX

#define GRID_CLASS_LOADLOCAL_code					0x071
#define GRID_CLASS_LOADLOCAL_frame					"%c%03xe%c",GRID_CONST_STX,GRID_CLASS_LOADLOCAL_code,GRID_CONST_ETX
...
#define GRID_CLASS_CLEARGLOBAL_frame				"%c%03xe%c",GRID_CONST_STX,GRID_CLASS_CLEARGLOBAL_code,GRID_CONST_ETX

#define GRID_CLASS_CLEARLOCAL_code					0x081
#define GRID_CLASS_CLEARLOCAL_frame					"%c%03xe%c",GRID_CONST_STX,GRID_CLASS_CLEARLOCAL_code,GRID_CONST_ETX

#define GRID_CLASS_DEBUGTEXT_code					0x090
