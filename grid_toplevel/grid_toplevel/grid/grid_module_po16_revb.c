...
static void grid_ui_button_hardware_transfer_complete_cb(void){
	...
	grid_ui_button_hardware_start_transfer();
}

static void grid_ui_button_hardware_init(void){
	
	adc_async_register_callback(&ADC_0, 0, ADC_ASYNC_CONVERT_CB, grid_ui_button_hardware_transfer_complete_cb);
	adc_async_register_callback(&ADC_1, 0, ADC_ASYNC_CONVERT_CB, grid_ui_button_hardware_transfer_complete_cb);
...
void grid_module_po16_revb_init(struct grid_ui_model* mod){
	...
	grid_ui_button_hardware_init();
	grid_ui_button_hardware_start_transfer();
	
}


void grid_ui_potentiometer_hardware_start_transfer(void){
...
void grid_ui_potentiometer_hardware_transfer_complete_cb(void){
...
void grid_ui_potentiometer_hardware_init(void){
	
	//adc_async_register_callback(&ADC_0, 0, ADC_ASYNC_CONVERT_CB, convert_cb_ADC_0);
	adc_async_register_callback(&ADC_1, 0, ADC_ASYNC_CONVERT_CB, grid_ui_potentiometer_hardware_transfer_complete_cb);
