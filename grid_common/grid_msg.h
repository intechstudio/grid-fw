...
#define grid_msg_packet_body_maxlength                                         \
  GRID_PARAMETER_PACKET_maxlength - grid_msg_packet_header_maxlength -         \
      GRID_MSG_FOOTER_maxlength
...
void grid_msg_packet_header_set_session(struct grid_msg_packet *msg,
                                        uint8_t session);
...
void grid_msg_packet_body_append_text(struct grid_msg_packet *msg,
                                      char *string);
...
uint8_t grid_msg_recent_fingerprint_find(struct grid_msg_model *mod,
                                         uint32_t fingerprint);

void grid_msg_recent_fingerprint_store(struct grid_msg_model *mod,
                                       uint32_t fingerprint);
