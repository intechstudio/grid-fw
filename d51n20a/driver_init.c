...
void FLASH_0_CLOCK_init(void) { hri_mclk_set_AHBMASK_NVMCTRL_bit(MCLK); }
...
void GRID_LED_PORT_init(void) {
  ...
  gpio_set_pin_function(PB30, PINMUX_PB30C_SERCOM7_PAD0);
...
void RAND_0_CLOCK_init(void) { hri_mclk_set_APBCMASK_TRNG_bit(MCLK); }
...
void USB_DEVICE_INSTANCE_PORT_init(void) {
  ...
  gpio_set_pin_function(PA24,
                        // <y> Pin function
                        // <id> pad_function
                        // <i> Auto : use driver pinmux if signal is imported by
                        // driver, else turn off function <PINMUX_PA24H_USB_DM">
                        // Auto <GPIO_PIN_FUNCTION_OFF"> Off
  ...
  gpio_set_pin_function(PA25,
                        ...
                        // <id> pad_function
                        // <i> Auto : use driver pinmux if signal is imported by
                        // driver, else turn off function <PINMUX_PA25H_USB_DP">
                        // Auto <GPIO_PIN_FUNCTION_OFF"> Off
                        // <GPIO_PIN_FUNCTION_A"> A
                        // <GPIO_PIN_FUNCTION_B"> B
                        // <GPIO_PIN_FUNCTION_C"> C
...
void WDT_0_CLOCK_init(void) { hri_mclk_set_APBAMASK_WDT_bit(MCLK); }
