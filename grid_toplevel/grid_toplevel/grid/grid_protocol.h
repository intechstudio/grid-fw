...
#define GRID_CLASS_MIDIRELATIVE_CABLECHANNEL_offset		5
#define GRID_CLASS_MIDIRELATIVE_CABLECHANNEL_length		2

#define GRID_CLASS_MIDIRELATIVE_CHANNELCOMMAND_offset		7
#define GRID_CLASS_MIDIRELATIVE_CHANNELCOMMAND_length		2
...
#define GRID_CLASS_MIDIRELATIVE_HWCFG_offset		5
#define GRID_CLASS_MIDIRELATIVE_HWCFG_length		2

#define GRID_CLASS_MIDIRELATIVE_VMAJOR_offset		7
#define GRID_CLASS_MIDIRELATIVE_VMAJOR_length		2

#define GRID_CLASS_MIDIRELATIVE_VMINOR_offset		9
#define GRID_CLASS_MIDIRELATIVE_VMINOR_length		2

#define GRID_CLASS_MIDIRELATIVE_VPATCH_offset		11
#define GRID_CLASS_MIDIRELATIVE_VPATCH_length		2
